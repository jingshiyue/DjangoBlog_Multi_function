...
class ArticleListView(ListView):
    ...
    paginate_by = 4
    page_kwarg = 'page'   #重写了父类的page_kwarg， 父类默认也是page
    link_type = 'l'
    model = Article
    ...
    def get_queryset_cache_key(self):  
        ...
        """
        raise NotImplementedError()   #表示子类中调用这个函数时，必须在子类里重写，否则报错
    ...
    def get_queryset(self):
        ...
        :return:
        '''
        # super(ArticleListView,self).get_queryset()
        super().get_queryset()
...
class ArticleDetailView(DetailView):
    ...
    model = Article
    pk_url_kwarg = 'article_id'  #重写主键字段
    ...
    def get_context_data(self, **kwargs):
        print("ArticleDetailView.get_context_data:",kwargs)
        print("ArticleDetailView.get_context_data:",self.kwargs)
...
class AuthorDetailView(ArticleListView):
    ...
    def get_queryset_data(self):
        author_name = self.kwargs['author_name']  #通过url拿到author_name传参
