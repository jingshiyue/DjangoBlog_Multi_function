...
def send_email_signal_handler(sender, **kwargs): #信号接收函数
...
def oauth_user_login_signal_handler(sender, **kwargs):
    ...
    delete_sidebar_cache(oauthuser.author.username) #用户认证通过后，发送信号过来，信号里删除用户的缓存碎片，.author.username通过外键关联到用户模型
